                        ...
                        public int?[] Calculate()
                        {
                            ...
                            while ((line = file.ReadLine()) != null)
                            {
                                ...
                                Lakes.Add(new Lake()
                                {
                                    ...
                                    WaterBalanceSurfaceFlowAvg = FromLine(lineS[22]),
WaterBalanceSurfaceOutflowAvg = FromLine(lineS[25]),
WaterBalanceUndergroundFlowAvg = FromLine(lineS[28]),
WaterBalanceUndergroundOutflowAvg = FromLine(lineS[31]),
WaterBalancePrecipitationAvg = FromLine(lineS[34]),
WaterBalanceEvaporationAvg = FromLine(lineS[37]),
WaterBalanceSurfaceFlowMax = FromLine(lineS[23]),
WaterBalanceSurfaceOutflowMax = FromLine(lineS[26]),
WaterBalanceUndergroundFlowMax = FromLine(lineS[29]),
WaterBalanceUndergroundOutflowMax = FromLine(lineS[32]),
WaterBalancePrecipitationMax = FromLine(lineS[35]),
WaterBalanceEvaporationMax = FromLine(lineS[38]),
WaterBalanceSurfaceFlowMin = FromLine(lineS[24]),
WaterBalanceSurfaceOutflowMin = FromLine(lineS[27]),
WaterBalanceUndergroundFlowMin = FromLine(lineS[30]),
WaterBalanceUndergroundOutflowMin = FromLine(lineS[33]),
WaterBalancePrecipitationMin = FromLine(lineS[36]),
WaterBalanceEvaporationMin = FromLine(lineS[39]),
            ...
            for(int i=0;i<lakes.Count();i++)
            {
                ...
                List<WaterBalance> waterBalances = _context.WaterBalance.Where(j => j.LakeId == lakes[i].LakeId).ToList();
